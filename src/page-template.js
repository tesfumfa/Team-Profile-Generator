...
<html lang="en"> 
  ...
  <body>
    ...
    //  let middleBucket = employeeBucket[0].getHTML()
     
    //  let array = employeeBucket.map((employee) => {
    ...
    // })
      ...
      `
          ...
          <footer>
          <p class="position-absolute bottom-0 start-50 translate-middle-x text-center">Team Profile Generator by TESFALEM TEGENGE</p>
          </footer>
          </body>
        </html>
      ` ; 
